                        ...
                        for c in cities:
                            ...
                            if c.get_autonomy_turns()<10:
                                ...
                                if c.get_num_tiles() > 1:
                                    expected_autonomy = (c.fuel + unit.cargo.fuel()) // (c.get_light_upkeep())
                                    prx(u_prefix, "XXXX1 auton+", c.cityid,c.get_num_tiles(), expected_autonomy)
                                    if expected_autonomy >= 10:
                                        pr(u_prefix, "We can save this city by raise autonomy to ",expected_autonomy)
